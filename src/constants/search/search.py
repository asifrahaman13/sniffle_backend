texts = [
    "⌨️ Health mterics AI agent which focuses chat bot only for data entry. Users can enter their quantitative data through text based prompts.",
    ...
    "🤖 Health mterics AI agent which focuses chat bot only for data entry. Users can enter their qualitiative data through text based prompts.",
    ...
    "📃 FHIR tool. A AI agent to convert image into text. Users can upload their image and get FHIR data format. Users can export the data with healthcare coach",
    ...
    "🎉 Recommendataion of the health data. A recommendation of the health data generated by the healthcare agents.",
    "📲 Wearable devices. A AI agent to connect wearable devices to the healthcare agents. Users can connect their wearable devices to the healthcare agents.",
    "👨🏼‍⚕️ A general healthcare agent which is focues on answering specialized healthcare topics thorugh chat based interface.",
    "🥼 A general healthcare agent which is focues on answering specialized healthcare topics through voice based interface.",
]
metadata = [
    {
        "screen": "Chat",
