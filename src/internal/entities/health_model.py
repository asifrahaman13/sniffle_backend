...
class HealthData(BaseModel):
    ...
    respiratory_rate: int = Field(description="The respiratory rate in breaths per minute")
    body_temperature: float = Field(description="The body temperature in degrees Celsius")

    step_count: int = Field(description="The number of steps taken by the user in the day")
    calories_burned: int = Field(description="The number of calories burned by the user in the day")
    distance_travelled: int = Field(description="The distance travelled by the user in the day")
...
class Recommendations(BaseModel):
    medications_recommended: str = Field(description="Medications recommended based on health data")
    diet_recommended: str = Field(description="Diet recommended based on health data")
    exercise_recommended: str = Field(description="Exercise recommended based on health data")
    ...
    other_recommendations: str = Field(description="Other recommendations based on health data")
...
class GeneralParameters(BaseModel):
    ...
    current_medications: str = Field(description="The current medical conditions of the user")
    allergies: str = Field(description="The allergies of the user")
    previous_medical_history: str = Field(description="The previous medical history of the user")
    family_medical_history: str = Field(description="The family medical history of the user")
