...
class HealthData(BaseModel):
    ...
    water_consumed: int = Field(
        description="The amount of water consumed in litres"
    )
    caffeine_consumed: int = Field(
        description="The amount of caffeine consumed in mg"
    )
    alcohol_consumed: int = Field(
        description="The amount of alcohol consumed in units"
    )
...
class GeneralParameters(BaseModel):
    ...
    surgical_history: str = Field(
        description="The surgical history of the user"
    )
